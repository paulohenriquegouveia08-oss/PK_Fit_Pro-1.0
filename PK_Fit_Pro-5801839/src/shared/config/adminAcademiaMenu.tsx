...
export const adminAcademiaMenuItems: MenuItem[] = [
    {
        label: 'Dashboard',
        path: '/admin-academia',
    ...
    {
        label: 'Solicitações',
        path: '/admin-academia/solicitacoes',
    ...
    {
        label: 'Mensalidades',
        path: '/admin-academia/mensalidades-vencendo',
    ...
    },
    {
        ...
        path: '/admin-academia/controle-acesso',
