        ...
        <DashboardLayout title="Dashboard" menuItems={menuItems}>
            <div className="admin-global-dashboard">
                ...
                <div className="download-card">
                    ...
                    <a href="https://github.com/paulohenriquegouveia08-oss/PK_Fit_Pro-1.0/raw/main/PK_Fit_Pro-web/public/downloads/PKFitAgent-v2-Setup.exe" download className="download-button-link">
