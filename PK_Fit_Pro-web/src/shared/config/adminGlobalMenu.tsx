...
export const adminGlobalMenuItems: MenuItem[] = [
    {
        label: 'Dashboard',
        path: '/admin-global',
    ...
    {
        label: 'Manual do Agente',
        path: '/admin-global/manual-agente',
    ...
    {
        label: 'Uso de Dados',
        path: '/admin-global/uso-de-dados',
